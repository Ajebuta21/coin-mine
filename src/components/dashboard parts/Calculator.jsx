    ...
    <div className="bg-white rounded p-4 shadow-md">
      ...
      <div className="grid grid-cols-4 gap-2">
        <button
          ...
          className="col-span-1 p-2 bg-green-800 text-white rounded hover:bg-white hover:text-green-800 border border-green-800 transition ease-in-out duration-500"
        >
          7
        </button>
        <button
      ...
      <div className="mt-4">
        ...
        <ul className="w-full bg-gray-100 h-20 overflow-auto p-2 rounded-md">
          {history.reverse().map((item, index) => (
            <li
              key={index}
              className="text-sm py-1 w-full border-b text-green-800"
            >
              {item}
            </li>
          ))}
